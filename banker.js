...
var req = [];
 ...
 R=num;
	...
	inp.setAttribute("style","text-align:center;margin:auto;float:left;border: 2px solid green; padding:10px;width: 40px;height: 20px;");
 ...
 var input=document.getElementById("inputsection");
	...
	inp1.setAttribute("style","width:50px;text-align:center;margin:auto;float:left;border: 2px solid green; padding:10px;width: 40px;height: 20px;");
	...
	inp2.setAttribute("style","width:50px;text-align:center;margin:auto;float:left;border: 2px solid green; padding:10px;width: 40px;height: 20px;");
...
function banker(){
 ...
 var p3 = document.createElement("input");
	p3.setAttribute("style","width:100px;text-align:center;margin:auto;float:left;border: 2px solid green; padding:10px;width: 40px;height: 20px;");
	...
	inp.setAttribute("style","width:50px;text-align:center;margin:auto;float:left;border: 2px solid green; padding:10px;width: 40px;height: 20px;");
	card.appendChild(inp);
	d3.appendChild(card);
	}
	var but = document.createElement("button");
